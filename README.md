...
```js
import { xmindBufferToKm, kmToXmindBuffer, downloadArrayBuffer } from 'xmind-kityminder';
...
| 特性 | xmindparser | xmind-kityminder |
|------|:---:|:---:|
| XMind 8 (XML) 解析 | ✅ | ✅ |
| XMind 2020+ (JSON) 解析 | ✅ | ✅ |
| 反向转换（KM → XMind） | ✅ | ✅ |
